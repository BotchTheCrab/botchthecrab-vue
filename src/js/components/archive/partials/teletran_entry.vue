...
<template>
  ...
  <div class="teletran-entry">
    <div class="teletran-box">
      <a v-bind:class="imageClass" rel="fancybox-button" v-bind:title="imageTitle" v-bind:data-character="imageTitle" v-bind:data-techspecs="entry.hasTechSpec || 'false'" v-bind:data-instructions="entry.hasInstructions || 'false'" v-bind:href="imagePath" v-bind:target="imageTarget">
      ...
      <div class="teletran-icons" v-if="!this.entry.transformerJapanId">
        <a v-if="entry.hasTechSpec" class="fancybox-button-techspecs" rel="fancybox-button" v-bind:title="imageTitle + ' - Tech Specs'" v-bind:data-character="imageTitle" data-art="true" v-bind:data-instructions="entry.hasInstructions || 'false'" v-bind:href="techSpecPath" target="_blank"><img src="/archive/images/icon_techspec.gif" v-bind:title="imageTitle + ' - Tech Specs'" /></a>
        <a v-if="entry.hasInstructions" class="fancybox-button-instructions" rel="fancybox-button" v-bind:title="imageTitle + ' - Instructions'" v-bind:data-character="imageTitle" data-art="true" v-bind:data-techspecs="entry.hasTechSpec || 'false'" v-bind:href="instructionsPath" target="_blank"><img src="/archive/images/icon_instruction.gif" v-bind:title="imageTitle + ' - Instructions'" /></a>
      </div>
