...
var __vueify_style_dispose__=require("vueify/lib/insert-css").insert("/* line 6, stdin */\n#create-posting .post-title input {\n  background: transparent;\n  border: transparent;\n  font-size: inherit;\n  font-family: inherit;\n  color: inherit; }\n\n/* line 16, stdin */\n#create-posting .post-body-full:not(.editor-loaded) {\n  visibility: hidden;\n  width: 0;\n  height: 0;\n  overflow: hidden; }\n\n/* line 24, stdin */\n#create-posting #create-posting-categories,\n#create-posting #create-posting-tags {\n  min-width: 300px; }\n\n/* line 29, stdin */\n#create-posting .post-footer-item {\n  margin: 20px 0; }\n  /* line 32, stdin */\n  #create-posting .post-footer-item > label {\n    display: inline-block;\n    width: 120px;\n    text-align: right;\n    margin-right: 10px; }\n\n/* line 43, stdin */\nbody.tox-fullscreen #menu_trigger_container,\nbody.tox-fullscreen #footer {\n  display: none; }\n\n/* line 49, stdin */\n.select2 {\n  margin: 0 !important; }\n  /* line 52, stdin */\n  .select2 .select2-selection__rendered,\n  .select2 .select2-selection__rendered * {\n    white-space: normal; }\n  /* line 57, stdin */\n  .select2 .select2-selection__choice__display {\n    color: black; }\n\n/* line 64, stdin */\n.select2-dropdown.create-posting-select2 .select2-results {\n  background-color: black;\n  text-align: left; }\n\n/* line 69, stdin */\n.select2-dropdown.create-posting-select2 .select2-results__option--selected {\n  background-color: #666; }\n\n/* line 74, stdin */\n#create-posting-posted {\n  font-family: Arial;\n  font-weight: normal;\n  width: 300px;\n  min-height: 32px;\n  border: 1px solid #aaa;\n  border-radius: 4px;\n  padding: 0 5px; }");!function(){"use strict";var e,t=require("services/global_service"),n=require("services/blog_service"),i=document.getElementsByTagName("head")[0];function s(e){var t=e.params.data.element,n=$(t);n.detach(),$(this).append(n),$(this).trigger("change"),$(".select2-search__field").val("")}module.exports={data:function(){return{editorLoaded:!1,posting:{postingId:null,title:"",content:"",posted:"",allowReplies:!0,categoryIds:[],tagIds:[]},categories:[],tags:[]}},beforeMount:function(){(e=this).initAuthorization()},mounted:function(){t.setOfficeDocumentTitle("Create Posting")},methods:{initAuthorization:function(){firebase.auth().onAuthStateChanged(function(t){if(t)console.log("SIGNED IN!"),e.initContentEditor(),e.initSelectors();else{console.log("NOT SIGNED IN!");var n=new firebase.auth.GoogleAuthProvider;firebase.auth().signInWithRedirect(n)}})},initContentEditor:function(){var t=document.createElement("script");t.src="https://cdn.tiny.cloud/1/casdhqgylieh1y3j27nsdxsrpn4f1qtupm3zddbpqzvref26/tinymce/5/tinymce.min.js",t.type="text/javascript",t.referrerPolicy="origin",t.onload=function(){e.tinymce=tinymce;tinymce.init({selector:"#create-posting-content",plugins:"image code lists charmap fullscreen media link",allow_script_urls:!0,convert_urls:!1,allow_unsafe_link_target:!0,browser_spellcheck:!0,extended_valid_elements:"a[href|target|onclick|class|style]",toolbar1:"bold italic underline strikethrough | aligncenter | outdent indent | numlist bullist",toolbar2:"charmap | fullscreen | image media link | code",skin:"oxide-dark",content_css:"dark, /css/cassette.css",content_style:"body { text-align: left; margin: 10px; }"}),e.editorLoaded=!0},i.appendChild(t)},initSelectors:function(){var t=document.createElement("link");t.href="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/css/select2.min.css",t.rel="stylesheet",i.appendChild(t);var n=document.createElement("script");n.src="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/js/select2.min.js",n.type="text/javascript",i.appendChild(n);e.getAllCategories().then(function(e){var t=_.map(e,function(e){return{id:e.categoryId,text:e.name}});$("#create-posting-categories").select2({data:t,closeOnSelect:!1,dropdownCssClass:"create-posting-select2"}).on("select2:select",s)}),e.getAllTags().then(function(e){var t=_.map(e,function(e){return{id:e.tagId,text:e.text}});t=_.sortBy(t,"text"),$("#create-posting-tags").select2({data:t,closeOnSelect:!1,dropdownCssClass:"create-posting-select2"}).on("select2:select",s)})},getAllCategories:function(){return n.getAllCategories().then(function(e){return e.val()})},getAllTags:function(){return n.getAllTags().then(function(e){return e.val()})},getContent:function(){e.posting.content=e.tinymce.activeEditor.getContent().replace("\n","").replace(/\n/g,"");var t=$("#create-posting-posted").val();t&&(e.posting.posted=t.replace("T"," ")+":00");var n=$("#create-posting-tags").select2("data");e.posting.tagIds=_.map(n,function(e){return Number(e.id)});var i=$("#create-posting-categories").select2("data");return e.posting.categoryIds=_.map(i,function(e){return Number(e.id)}),e.posting},createPosting:function(){var t=e.getContent();t.title?t.content?t.tagIds.length?t.categoryIds.length?t.posted?n.getAllPostings().then(function(i){var s=i.val(),o=s.length,r=_.max(s,"postingId").postingId+1;t.postingId=r;var a={};return a["blog/postings/"+o]=t,firebase.database().ref().update(a).then(function(t){window.alert("Your posting was successfully submitted!"),n.getAllPostings(!0).then(function(){e.$router.push({path:"/"})})},function(e){console.error(e),window.alert("There was an error attempting to submit your posting.")})}):window.alert("Posted time is missing."):window.alert("Categories are missing."):window.alert("Tags are missing."):window.alert("Content is missing."):window.alert("Title is missing.")}}}}(),module.exports.__esModule&&(module.exports=module.exports.default);var __vue__options__="function"==typeof module.exports?module.exports.options:module.exports;__vue__options__.functional&&console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions."),__vue__options__.render=function(){var e=this,t=e.$createElement,n=e._self._c||t;return n("div",{staticClass:"container-fluid center-content",attrs:{id:"create-posting"}},[n("botch-watermark"),e._v(" "),n("div",{staticClass:"post-title"},[n("input",{directives:[{name:"model",rawName:"v-model",value:e.posting.title,expression:"posting.title"}],attrs:{type:"text",placeholder:"Post Title Here"},domProps:{value:e.posting.title},on:{input:function(t){t.target.composing||e.$set(e.posting,"title",t.target.value)}}})]),e._v(" "),n("div",{class:{"post-body-full":!0,"editor-loaded":e.editorLoaded}},[n("textarea",{directives:[{name:"mode",rawName:"v-mode",value:e.posting.content,expression:"posting.content"}],attrs:{id:"create-posting-content",rows:"20"}})]),e._v(" "),n("div",{staticClass:"post-footer",style:{visibility:e.editorLoaded?"visible":"hidden"}},[n("div",{staticClass:"post-footer-item"},[n("label",[e._v("Tags:")]),e._v(" "),n("select",{directives:[{name:"model",rawName:"v-model",value:e.posting.tagIds,expression:"posting.tagIds"}],attrs:{multiple:"",id:"create-posting-tags"},on:{change:function(t){var n=Array.prototype.filter.call(t.target.options,function(e){return e.selected}).map(function(e){return"_value"in e?e._value:e.value});e.$set(e.posting,"tagIds",t.target.multiple?n:n[0])}}})]),e._v(" "),n("div",{staticClass:"post-footer-item"},[n("label",[e._v("Categories:")]),e._v(" "),n("select",{directives:[{name:"model",rawName:"v-model",value:e.posting.categoryIds,expression:"posting.categoryIds"}],attrs:{multiple:"",id:"create-posting-categories"},on:{change:function(t){var n=Array.prototype.filter.call(t.target.options,function(e){return e.selected}).map(function(e){return"_value"in e?e._value:e.value});e.$set(e.posting,"categoryIds",t.target.multiple?n:n[0])}}})]),e._v(" "),n("div",{staticClass:"post-footer-item"},[n("label",[e._v("Allow Replies:")]),e._v(" "),n("input",{directives:[{name:"model",rawName:"v-model",value:e.posting.allowReplies,expression:"posting.allowReplies"}],attrs:{type:"checkbox"},domProps:{checked:Array.isArray(e.posting.allowReplies)?e._i(e.posting.allowReplies,null)>-1:e.posting.allowReplies},on:{change:function(t){var n=e.posting.allowReplies,i=t.target,s=!!i.checked;if(Array.isArray(n)){var o=e._i(n,null);i.checked?o<0&&e.$set(e.posting,"allowReplies",n.concat([null])):o>-1&&e.$set(e.posting,"allowReplies",n.slice(0,o).concat(n.slice(o+1)))}else e.$set(e.posting,"allowReplies",s)}}})]),e._v(" "),e._m(0)]),e._v(" "),n("button",{on:{click:e.createPosting}},[e._v("Post")])],1)},__vue__options__.staticRenderFns=[function(){var e=this.$createElement,t=this._self._c||e;return t("div",{staticClass:"post-footer-item"},[t("label",[this._v("Posted:")]),this._v(" "),t("input",{attrs:{type:"datetime-local",id:"create-posting-posted"}})])}],module.hot&&function(){var e=require("vue-hot-reload-api");e.install(require("vue"),!0),e.compatible&&(module.hot.accept(),module.hot.dispose(__vueify_style_dispose__),module.hot.data?e.rerender("data-v-4b662998",__vue__options__):e.createRecord("data-v-4b662998",__vue__options__))}();
...
var __vueify_style_dispose__=require("vueify/lib/insert-css").insert("/* */");!function(){"use strict";var e=[{text:"1984",link:"#/archive/teletran/FACTION/1984"},{text:"1985",link:"#/archive/teletran/FACTION/1985"},{text:"1986",link:"#/archive/teletran/FACTION/1986"},{text:"1987",link:"#/archive/teletran/FACTION/1987"},{text:"1988",link:"#/archive/teletran/FACTION/1988"},{text:"1989",link:"#/archive/teletran/FACTION/1989"},{text:"1990",link:"#/archive/teletran/FACTION/1990"},{text:"Action Masters",link:"#/archive/teletran/FACTION/action_masters"},{text:"Japanese Exclusives",link:"#/archive/teletran/FACTION/japan"},{text:"European Exclusives",link:"#/archive/teletran/FACTION/europe"}],t=[{text:"Home",menuIconId:"home",link:"#/"},{text:"Transformers <br/>Box Art Archive",menuIconId:"archive",link:"#/archive",children:[{text:"Recent Updates"},{text:"Autobots",menuIconId:"autobot",link:"#/archive/teletran/autobot",children:_.map(e,function(e){return{text:e.text,link:e.link.replace(/FACTION/g,"autobot")}})},{text:"Decepticons",menuIconId:"decepticon",link:"#/archive/teletran/decepticon",children:_.map(e,function(e){return{text:e.text,link:e.link.replace(/FACTION/g,"decepticon")}})},{text:"Tech Specs",link:"#/archive/techspecs"},{text:"Instructions",link:"#/archive/instructions"},{text:"Back of the Box Art",link:"#/archive/boxbattles"},{text:"Catalogs",link:"#/archive/catalogs"},{text:"Reinforcements From Cybertron",link:"#/archive/reinforcements"},{text:"Box Art History",link:"#/archive/history"},{text:"Edit / Scan / Donate",link:"#/archive/help  "}]},{text:"Music",menuIconId:"music",link:"#/about/music"},{text:"More Galleries",link:"#/galleries"},{text:"About ...",link:"#/about",children:[{text:"Adam Alexander",link:"#/about/adam"},{text:"Botch the Crab",link:"#/about/botch"},{text:"Botch's Fellow Cassettes",link:"#/about/trio"},{text:"This Site",link:"#/about/site"}]},{text:"Browse Tags",link:"#/tags"},{text:"FAQ / Contact",link:"#/contact"},{text:"R&#0233;sum&#0233;",link:"/images/about/adam/adam-alexander-resume-2021.pdf",external:!0}];module.exports={props:["currentRoute"],data:function(){return{menuStructure:t,btcMenu:null}},mounted:function(){var e=this;$(document).ready(function(){e.btcMenu=new Mmenu("#menu",{navbar:{add:!0,title:"Botch the Crab",titleLink:"none",sticky:!1},onclick:{close:!0,preventDefault:!1,setSelected:!0},slidingSubmenus:!0,wrappers:[],extensions:["position-front"]},{classNames:{selected:"menuItemSelected"}});var t=$("#menu");t.on("click",function(t){var n=t.target.closest('a[href^="#/"]');n&&n.hash&&(location.hash=n.hash,e.btcMenu.API.close())}),t.css("visibility","visible"),window.triggerMenuUpdate=e.updateMenuSelection;var n={path:location.hash.substring(1)};e.updateMenuSelection(n)})},methods:{updateMenuSelection:function(e){if(e&&e.path){var t=$('#menu a[href="#'+e.path+'"]');if(t.length){var n=t.closest("li");if(n&&n.length){var i=n.closest("ul");this.btcMenu.API.setSelected(n[0]),this.btcMenu.API.openPanel(i[0])}}}}}}}(),module.exports.__esModule&&(module.exports=module.exports.default);var __vue__options__="function"==typeof module.exports?module.exports.options:module.exports;__vue__options__.functional&&console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions."),__vue__options__.render=function(){var e=this,t=e.$createElement,n=e._self._c||t;return n("ul",e._l(e.menuStructure,function(t){return n("li",[n("a",{attrs:{href:t.link,target:t.external?"_blank":"_self"}},[t.menuIconId?n("span",{staticClass:"menu_icon",attrs:{id:"menu_icon_"+t.menuIconId},domProps:{innerHTML:e._s(t.text)}}):e._e(),e._v(" "),t.menuIconId?e._e():n("span",{domProps:{innerHTML:e._s(t.text)}})]),e._v(" "),t.children?n("ul",e._l(t.children,function(t){return n("li",[n("a",{attrs:{href:t.link,target:t.external?"_blank":"_self"}},[t.menuIconId?n("span",{staticClass:"menu_icon",attrs:{id:"menu_icon_"+t.menuIconId},domProps:{innerHTML:e._s(t.text)}}):e._e(),e._v(" "),t.menuIconId?e._e():n("span",{domProps:{innerHTML:e._s(t.text)}})]),e._v(" "),t.children?n("ul",e._l(t.children,function(t){return n("li",[n("a",{attrs:{href:t.link,target:t.external?"_blank":"_self"}},[t.menuIconId?n("span",{staticClass:"menu_icon",attrs:{id:"menu_icon_"+t.menuIconId},domProps:{innerHTML:e._s(t.text)}}):e._e(),e._v(" "),t.menuIconId?e._e():n("span",{domProps:{innerHTML:e._s(t.text)}})])])}),0):e._e()])}),0):e._e()])}),0)},__vue__options__.staticRenderFns=[],module.hot&&function(){var e=require("vue-hot-reload-api");e.install(require("vue"),!0),e.compatible&&(module.hot.accept(),module.hot.dispose(__vueify_style_dispose__),module.hot.data?e.rerender("data-v-4dcde268",__vue__options__):e.createRecord("data-v-4dcde268",__vue__options__))}();
...
var __vueify_style_dispose__=require("vueify/lib/insert-css").insert('/* line 5, stdin */\n#postings #main-search-form {\n  margin-bottom: 30px; }\n  /* line 9, stdin */\n  #postings #main-search-form #main-search-input input, #postings #main-search-form #main-search-input select {\n    margin: 0 5px 10px; }\n    /* line 12, stdin */\n    #postings #main-search-form #main-search-input input[type="submit"], #postings #main-search-form #main-search-input select[type="submit"] {\n      width: 100px; }\n\n/* line 19, stdin */\n#postings .teletran-container {\n  margin-bottom: 30px; }');!function(){"use strict";var e,t=require("services/global_service"),r=(require("services/archive_service"),require("components/archive/partials/teletran_entry")),s=require("services/blog_service"),n=null,o=0,i=null,a=0,l=null;module.exports={data:function(){return{pageTitle:"",query:{},transformers:[],totalTransformers:null,postings:[],totalPostings:null,transformersReady:!1,postingsReady:!1}},components:{"teletran-entry":r},watch:{$route:function(t,r){e.init()}},beforeMount:function(){(e=this).init()},methods:{init:function(){e.totalTransformers=null,e.transformersReady=!1,e.postingsReady=!1,e.parseQuery().then(function(){e.setPageTitle(),e.initTransformers(),e.initPostings()})},parseQuery:function(){return e.query=this.$route.query||{},e.query.search=e.query.search||"",e.query.scope=e.query.scope||"site",e.query.tag?s.getAllTags().then(function(t){var r=t.val(),s=_.findWhere(r,{text:e.query.tag});e.query.tagId=s.tagId}):(e.query.newSearch=String(e.query&&e.query.search||""),e.query.newScope=String(e.query&&e.query.scope||"site"),Promise.resolve())},setPageTitle:function(){var r=e.query&&e.query.tagId?Number(e.query.tagId):null,n=e.query&&e.query.search?e.query.search.toLowerCase():null;n?(e.pageTitle='Search Results for "'+n+'"',t.setOfficeDocumentTitle(e.pageTitle)):r?s.getAllTags().then(function(s){var n=s.val(),o=_.findWhere(n,{tagId:r});o&&o.text&&(e.pageTitle="Posts tagged "+o.text,t.setOfficeDocumentTitle(e.pageTitle))}):(e.pageTitle="Adam's Blog and Archive Updates",t.setOfficeDocumentTitle(e.pageTitle))},initTransformers:function(){n=null,o=0,e.transformers=[];var t=(e.query.search||"").toLowerCase();if(t){var r=function(e){return _.filter(e.val(),function(e){return-1!==e.name.toLowerCase().indexOf(t)})},s=$.Deferred(function(e){firebase.database().ref("archive/transformers_usa").once("value").then(function(t){var s=r(t);e.resolve(s)})}).promise(),i=$.Deferred(function(e){firebase.database().ref("archive/micromasters").once("value").then(function(t){var s=r(t);e.resolve(s)})}).promise(),a=$.Deferred(function(e){firebase.database().ref("archive/action_masters").once("value").then(function(t){var s=r(t);s=_.where(s,{region:"USA"}),e.resolve(s)})}).promise(),l=$.Deferred(function(e){firebase.database().ref("archive/transformers_europe").once("value").then(function(t){var s=r(t);e.resolve(s)})}).promise(),u=$.Deferred(function(e){firebase.database().ref("archive/transformers_japan").once("value").then(function(t){var s=r(t);e.resolve(s)})}).promise();return $.when(s,i,a,l,u).done(function(t,r,s,o,i){n=_.flatten([t,r,s,o,i]),e.totalTransformers=n.length,e.loadInitialTransformers(),e.transformersReady=!0})}e.transformersReady=!0},loadInitialTransformers:function(){var t=5;o>5&&(t=o);var r=n.slice(0,t);_.each(r,function(t){e.transformers.push(t)}),o=t},loadAllTransformers:function(){e.transformers=n},initPostings:function(){i=null,a=0,e.postings=[];_.keys(e.query);if(e.query&&(e.query.search||e.query.tagId)){var t=$.Deferred(function(e){s.getAllPostings().then(function(t){e.resolve(t.val())})}).promise(),r=$.Deferred(function(e){s.getAllReplies().then(function(t){e.resolve(t.val())})}).promise();$.when(t,r).done(function(t,r){i=_.sortBy(t,"posted").reverse(),l=_.groupBy(r,"postingId"),_.each(l,function(e,t){var r=_.findWhere(i,{postingId:Number(t)});r&&(r.replyCount=e.length)}),e.filterPostings(),e.loadInitialPostings(),e.postingsReady=!0})}else e.postingsReady=!0,window.setTimeout(function(){$("#keywords").focus()},500)},filterPostings:function(){var t=e.query&&e.query.tagId?Number(e.query.tagId):null,r=e.query&&e.query.search||null,s=e.query&&e.query.scope||null;if(r){var n=[];if("archive"===s){i=_.filter(i,function(e){return Array.isArray(e.tagIds)&&-1!==e.tagIds.indexOf(1)})}var o=r.split(" ");o=_.difference(o,["a","an","the","to","in"]),_.each(o,function(e){var t=new RegExp("\\b"+e+"\\b","ig"),r=_.filter(i,function(e){return-1!==e.title.search(t)||-1!==e.content.search(t)});_.each(r,function(e){e.weight=0,-1!==e.title.search(t)&&(e.weight=5);var r=e.content.match(t)||[];e.weight+=r.length;var s=_.findWhere(n,{postingId:e.postingId});s?s.weight+=e.weight:n.push(e)})});var a=new RegExp(r,"i");_.each(n,function(e){e.title.match(a)&&(e.weight+=50),e.content.match(a)&&(e.weight+=5)}),i=_.sortBy(n,"weight").reverse()}else i=t?_.filter(i,function(e){return Array.isArray(e.tagIds)&&-1!==e.tagIds.indexOf(t)}):[];e.totalPostings=i.length},loadInitialPostings:function(){var t=5;a>5&&(t=a);var r=i.slice(0,t);r=s.setPostingBlurbs(r),_.each(r,function(t){e.postings.push(t)}),a=t},loadMorePostings:function(){var t=a+5,r=i.slice(a,t);r=s.setPostingBlurbs(r),_.each(r,function(t){e.postings.push(t)}),a=t},formatPosted:function(e){return t.formatPosted(e)},submitSearch:function(){this.$router.push({path:"/postings",query:{search:e.query.newSearch,scope:e.query.newScope}})}}}}(),module.exports.__esModule&&(module.exports=module.exports.default);var __vue__options__="function"==typeof module.exports?module.exports.options:module.exports;__vue__options__.functional&&console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions."),__vue__options__.render=function(){var e=this,t=e.$createElement,r=e._self._c||t;return r("div",{staticClass:"container-fluid center-content",attrs:{id:"postings"}},[r("botch-watermark"),e._v(" "),e.pageTitle?r("div",{staticClass:"page-title"},[e._v(e._s(e.pageTitle))]):e._e(),e._v(" "),r("form",{directives:[{name:"show",rawName:"v-show",value:e.pageTitle,expression:"pageTitle"}],attrs:{id:"main-search-form"},on:{submit:function(t){return t.preventDefault(),e.submitSearch(t)}}},[r("div",{attrs:{id:"main-search-input"}},[r("input",{directives:[{name:"model",rawName:"v-model",value:e.query.newSearch,expression:"query.newSearch"}],attrs:{type:"search",name:"keywords",id:"keywords",placeholder:"Search ..."},domProps:{value:e.query.newSearch},on:{click:function(e){return e.target.select()},input:function(t){t.target.composing||e.$set(e.query,"newSearch",t.target.value)}}}),e._v(" "),r("select",{directives:[{name:"model",rawName:"v-model",value:e.query.newScope,expression:"query.newScope"}],on:{change:function(t){var r=Array.prototype.filter.call(t.target.options,function(e){return e.selected}).map(function(e){return"_value"in e?e._value:e.value});e.$set(e.query,"newScope",t.target.multiple?r:r[0])}}},[r("option",{attrs:{value:"site"}},[e._v("Entire Site")]),e._v(" "),r("option",{attrs:{value:"archive"}},[e._v("Box Art Archive")])]),e._v(" "),r("input",{attrs:{type:"submit",value:"Search"}})])]),e._v(" "),e.query.search?r("div",{staticClass:"page-subheader"},[e._v("Transformers Box Art Results ...")]):e._e(),e._v(" "),e.transformersReady?e._e():r("div",[e._v("Loading ...")]),e._v(" "),e.transformersReady&&e.query.search&&0===e.transformers.length?r("div",[e._v("No matching Transformers")]):e._e(),e._v(" "),r("div",{staticClass:"teletran-container teletran-container-search"},[e._l(e.transformers,function(e){return r("teletran-entry",{key:e.transformerId,attrs:{entry:e}})}),e._v(" "),e.totalTransformers&&e.transformers.length<e.totalTransformers?r("div",{staticClass:"teletran-load-more",on:{click:e.loadAllTransformers}},[e._v("Load All Matching Transformers")]):e._e()],2),e._v(" "),e.query.search?r("div",{staticClass:"page-subheader"},[e._v("Postings ...")]):e._e(),e._v(" "),e.postingsReady?e._e():r("div",[e._v("Loading ...")]),e._v(" "),e.postingsReady&&e.query.search&&0===e.postings.length?r("div",[e._v("No matching posts")]):e._e(),e._v(" "),e._l(e.postings,function(t){return r("div",{key:t.postingId,staticClass:"post-blurb",attrs:{"post-id":t.postingId}},[r("div",{staticClass:"post-title-full"},[r("router-link",{attrs:{to:{name:"posting",params:{postingId:t.postingId}}}},[e._v(e._s(t.title))])],1),e._v(" "),r("div",{staticClass:"post-details"},[r("span",{staticClass:"post-timestamp"},[r("label",[e._v("Posted:")]),e._v(" "+e._s(e.formatPosted(t.posted)))]),t.replyCount>0?r("span",{staticClass:"post-reply-count"},[r("router-link",{attrs:{to:{name:"posting",params:{postingId:t.postingId,scrollTo:"replies"}}}},[e._v(e._s(t.replyCount)+" "+e._s(1===t.replyCount?"Reply":"Replies"))])],1):e._e()]),e._v(" "),r("div",{staticClass:"post-body-full",domProps:{innerHTML:e._s(t.blurb)}}),e._v(" "),t.blurb.length!==t.content.length?r("p",{staticClass:"post-body-trimmed"},[r("router-link",{attrs:{to:{name:"posting",params:{postingId:t.postingId}}}},[e._v("Continue …")])],1):e._e()])}),e._v(" "),r("div",{directives:[{name:"show",rawName:"v-show",value:e.postings.length&&e.postings.length<e.totalPostings,expression:"postings.length && postings.length < totalPostings"}],staticClass:"more-posts"},[r("a",{on:{click:e.loadMorePostings}},[e._v("Load More Posts")])]),e._v(" "),r("div",{directives:[{name:"show",rawName:"v-show",value:e.postings.length&&e.postings.length===e.totalPostings,expression:"postings.length && postings.length === totalPostings"}],staticClass:"no-more-posts"},[e._v("\n    No more posts.\n  ")])],2)},__vue__options__.staticRenderFns=[],module.hot&&function(){var e=require("vue-hot-reload-api");e.install(require("vue"),!0),e.compatible&&(module.hot.accept(),module.hot.dispose(__vueify_style_dispose__),module.hot.data?e.rerender("data-v-370a9822",__vue__options__):e.createRecord("data-v-370a9822",__vue__options__))}();
...
$(document).ready(function(){firebase.initializeApp({apiKey:"AIzaSyCWCpbe1wdg1v1uJqPZRGv0q6pT8QZiscE",authDomain:"botch-the-crab.firebaseapp.com",databaseURL:"https://botch-the-crab.firebaseio.com",projectId:"botch-the-crab",storageBucket:"botch-the-crab.appspot.com",messagingSenderId:"957369815270",appId:"1:957369815270:web:3ca19aaadf385f84632b27"});var e=require("services/fancybox_service.js");Vue.use(VueRouter);var t=require("services/global_service"),o=require("components/partials/menu_content"),n=require("components/partials/menu_trigger"),r=require("components/partials/back_to_top"),a=require("components/partials/footer"),c=require("components/partials/sfx"),p=require("components/home"),i=require("components/posting"),s=require("components/postings"),m=require("components/createPosting"),u=require("components/tags"),h=require("components/contact"),l=require("components/archive/archive_home"),b=require("components/archive/faction"),g=require("components/archive/teletran"),q=require("components/archive/teletran_micromasters"),v=require("components/archive/techspecs"),y=require("components/archive/instructions"),f=require("components/archive/catalogs"),d=require("components/archive/boxbattles"),_=require("components/archive/reinforcements"),w=require("components/archive/history"),V=require("components/galleries"),x=require("components/gallery"),I=require("components/galleryEntry"),E=require("components/about/about_home"),C=require("components/about/about_adam"),R=require("components/about/about_botch"),k=require("components/about/about_trio"),B=require("components/about/about_music"),T=require("components/about/about_site"),U=new VueRouter({routes:[{path:"/",component:p},{path:"/posting/:postingId",name:"posting",component:i},{path:"/postings",name:"postings",component:s},{path:"/posting/create/new",component:m},{path:"/tags",component:u},{path:"/contact",component:h},{path:"/archive",component:l},{path:"/archive/teletran/:faction",component:b},{path:"/archive/teletran/:faction/:year",component:g},{path:"/archive/teletran/:faction/:year/:micromasterTeam",component:q},{path:"/archive/techspecs",component:v},{path:"/archive/instructions",component:y},{path:"/archive/catalogs",component:f},{path:"/archive/boxbattles",component:d},{path:"/archive/reinforcements",component:_},{path:"/archive/history",component:w},{path:"/galleries",component:V},{path:"/gallery/:galleryId",name:"gallery",component:x},{path:"/gallery/galleryEntry/:galleryEntryId",name:"galleryEntry",component:I},{path:"/about",component:E},{path:"/about/adam",component:C},{path:"/about/botch",component:R},{path:"/about/trio",component:k},{path:"/about/music",component:B},{path:"/about/site",component:T}]});new Vue({el:"#menu",components:{"menu-content":o}}),new Vue({el:"#menu_trigger_container",components:{"menu-trigger":n}}),new Vue({el:"#back-to-top",components:{"back-to-top":r}}),new Vue({el:"#footer",router:U,components:{"global-footer":a}}),new Vue({el:"#sfx-container",router:U,components:{sfx:c}}),new Vue({router:U}).$mount("#main");t.setBodyClass(t.getCurrentRoute()),U.afterEach(function(e,o,n){"function"==typeof window.triggerMenuUpdate&&window.triggerMenuUpdate(e,o),t.setBodyClass(e.path),t.scrollTop()}),e.initFancyBox()});
...
var allPostingsSnapshot,allCategoriesSnapshot,allTagsSnapshot,allRepliesSnapshot,allPostings=null;function getAllPostings(e){var t=$.Deferred();return allPostingsSnapshot&&!e?t.resolve(allPostingsSnapshot):firebase.database().ref("blog/postings").once("value").then(function(e){allPostingsSnapshot=e,t.resolve(allPostingsSnapshot)}),t.promise()}function getAllCategories(){var e=$.Deferred();return allCategoriesSnapshot?e.resolve(allCategoriesSnapshot):firebase.database().ref("blog/categories").once("value").then(function(t){allCategoriesSnapshot=t,e.resolve(allCategoriesSnapshot)}),e.promise()}function getAllTags(){var e=$.Deferred();return allTagsSnapshot?e.resolve(allTagsSnapshot):firebase.database().ref("blog/tags").once("value").then(function(t){allTagsSnapshot=t,e.resolve(allTagsSnapshot)}),e.promise()}function getAllReplies(e){var t=$.Deferred();return allRepliesSnapshot&&!e?t.resolve(allRepliesSnapshot):firebase.database().ref("blog/replies").once("value").then(function(e){allRepliesSnapshot=e,t.resolve(allRepliesSnapshot)}),t.promise()}function setPostingBlurbs(e){var t=/<p(.|\n|\r)+?<\/p>/gi;return _.each(e,function(e){var o=e.content.match(t);o&&o.length>2?e.blurb=o[0]+o[1]:e.blurb=e.content}),e}function createPostReply(e,t){var o=getAllReplies(!0).then(function(e){return e.val()}),n=$.get("https://www.cloudflare.com/cdn-cgi/trace").then(function(e){return e.match(/[0-9]{1,3}.[0-9]{1,3}.[0-9]{1,3}.[0-9]{1,3}/)[0]});return $.when(o,n).done(function(o,n){var r=o.length,s={replyId:r+1,postingId:e.postingId,posted:getNewPostTime(),poster:t.poster,content:t.content,address:n,notify:t.notify||!1};t.email&&(s.email=t.email),t.website&&(s.website=t.website);var a={};return a["blog/replies/"+r]=s,firebase.database().ref().update(a).then(function(n){var r=_.chain(o).where({postingId:e.postingId,notify:!0}).filter(function(e){var o=e.email.toLowerCase();return"botch@botchthecrab.com"!==o&&o!==t.email}).map(function(e){return e.email.toLowerCase()}).unique().value();r.unshift("botch@botchthecrab.com");var a=[];return _.each(r,function(o){var n={to:o,message:{subject:'New Comment for "'+e.title+'" [BotchTheCrab.com]',html:"<p><b>"+t.poster+"</b> "+(t.website?'[<a href="'+t.website+'">'+t.website+"</a>] ":"")+"wrote the following on "+s.posted+":<br /></p><p>"+s.content.replace(/\n/g,"<br/>")+'</p><p><a href="https://botchthecrab.com/#/posting/'+e.postingId+'">View posting</a></p><hr style="margin: 2em 0 1em" /><p><i>To unsubscribe to comments from this post, reply back with the word "Unsubscribe" and Botch will adjust your notification settings.</i></p>'},fromBTC:!0},r=firebase.firestore().collection("mail").add(n).then(function(e){return console.log("Document written with ID: ",e.id),s}).catch(function(e){return console.error("Error adding document: ",e),e});a.push(r)}),$.when(a)},function(e){return console.error(e),window.alert("There was an error attempting to submit your reply."),e})})}function getNewPostTime(){var e=new Date;return e.getFullYear()+"-"+zeroPad(e.getMonth()+1)+"-"+zeroPad(e.getDate())+" "+zeroPad(e.getHours())+":"+zeroPad(e.getMinutes())+":"+zeroPad(e.getSeconds())}function zeroPad(e){return e<10?"0"+e:e}module.exports={getAllPostings:getAllPostings,getAllCategories:getAllCategories,getAllTags:getAllTags,getAllReplies:getAllReplies,setPostingBlurbs:setPostingBlurbs,createPostReply:createPostReply};

},{}],48:[function(require,module,exports){
var storage="undefined"!=typeof Storage,now=new Date,one_year=new Date(now.getUTCFullYear()+1,now.getUTCMonth(),now.getUTCDate());module.exports={setCookie:function(o,e,t,n,r,c){storage?localStorage[o]=e:(t=t||one_year,document.cookie=o+"="+e+(t?";expires="+t.toUTCString():"")+(n?";path="+n:"")+(r?";domain="+r:"")+(c?";secure":""))},readCookie:function(o){if(storage&&localStorage[o])return localStorage[o];if(document.cookie){var e=new RegExp("\\b"+o+"=","i"),t=document.cookie.search(e);return-1!=t&&(cookieStart=t+o.length+1,cookieStop=document.cookie.indexOf(";",t),-1==cookieStop&&(cookieStop=document.cookie.length),document.cookie.substring(cookieStart,cookieStop))}return!1}};

},{}],49:[function(require,module,exports){
var fancyBoxDefaults={prevEffect:"fade",nextEffect:"fade",arrows:!0,closeBtn:!0,loop:!1,helpers:{title:{type:"inside"}},minWidth:225,minHeight:50,margin:50,padding:20},fancyBoxSwipeInitialized=!1;function buildFancyboxPopIcon(t){return'<div class="fancybox-download" title="open image in new window"><a href="'+t+'" target="_blank"><img src="/images/icon_newwin.png" /></a></div>'}function initFancyBox(){var t=this.buildFancyboxPopIcon;_.extend(window,{openBoxArt:this.openBoxArt,openTechSpecs:this.openTechSpecs,openInstructions:this.openInstructions}),$(".fancybox-button-art").fancybox($.extend({beforeLoad:function(){var e=$(this.element).data("character"),n=Boolean($(this.element).data("techspecs")),o=Boolean($(this.element).data("instructions"));if(this.title=t(this.href)+this.title,n||o){var i='<div class="fancybox-additional-links">';n&&(i+='<a class="open-techspecs" href="javascript:void(openTechSpecs(\''+e+"'))\">Tech Specs</a>"),o&&(i+='<a class="open-instructions" href="javascript:void(openInstructions(\''+e+"'))\">Instructions</a>"),i+="</div>",this.title+=i}}},fancyBoxDefaults)),$(".fancybox-button-techspecs").fancybox($.extend({beforeLoad:function(){var e=$(this.element).data("character"),n=Boolean($(this.element).data("art")),o=Boolean($(this.element).data("instructions"));if(this.title=t(this.href)+this.title,n||o){var i='<div class="fancybox-additional-links">';n&&(i+='<a class="open-boxart" href="javascript:void(openBoxArt(\''+e+"'))\">Box Art</a>"),o&&(i+='<a class="open-instructions" href="javascript:void(openInstructions(\''+e+"'))\">Instructions</a>"),i+="</div>",this.title+=i}}},fancyBoxDefaults)),$(".fancybox-button-instructions").fancybox($.extend({beforeLoad:function(){var e=$(this.element).data("character"),n=Boolean($(this.element).data("art")),o=Boolean($(this.element).data("techspecs"));if(this.title=t(this.href)+this.title,n||o){var i='<div class="fancybox-additional-links">';n&&(i+='<a class="open-boxart" href="javascript:void(openBoxArt(\''+e+"'))\">Box Art</a>"),o&&(i+='<a class="open-techspecs" href="javascript:void(openTechSpecs(\''+e+"'))\">Tech Specs</a>"),i+="</div>",this.title+=i}}},fancyBoxDefaults))}function openBoxArt(t){$.fancybox.close(!0),$(".fancybox-button-art").filter('[title="'+t+'"]').trigger("click")}function openTechSpecs(t){$.fancybox.close(!0),$(".fancybox-button-techspecs").filter('[title="'+t+' - Tech Specs"]').trigger("click")}function openInstructions(t){$.fancybox.close(!0),$(".fancybox-button-instructions").filter('[title="'+t+' - Instructions"]').trigger("click")}function openImage(t,e){$.fancybox.open([{href:e,title:buildFancyboxPopIcon(e)+t}],fancyBoxDefaults)}module.exports={buildFancyboxPopIcon:buildFancyboxPopIcon,initFancyBox:initFancyBox,openBoxArt:openBoxArt,openTechSpecs:openTechSpecs,openInstructions:openInstructions,openImage:openImage};

},{}],50:[function(require,module,exports){
function getCurrentRoute(){return location.hash.substring(1)}function setBodyClass(t){var e="";-1!==t.indexOf("/autobot")?e="autobot":-1!==t.indexOf("/decepticon")&&(e="decepticon"),$("body").attr("class",e)}function setOfficeDocumentTitle(t){document.title="Botch the Crab"+(t?" - "+t:"")}function setArchiveDocumentTitle(t){document.title="Botch's Transformers Box Art Archive"+(t?" - "+t:"")}function formatPosted(t){var e=t.split(" "),o=e[0],n=e[1];return o+" "+(n="00:00:00"===n?"":n.substring(0,5))}function scrollTop(){$("html, body").animate({scrollTop:0},"250","swing")}module.exports={getCurrentRoute:getCurrentRoute,setBodyClass:setBodyClass,setOfficeDocumentTitle:setOfficeDocumentTitle,setArchiveDocumentTitle:setArchiveDocumentTitle,formatPosted:formatPosted,scrollTop:scrollTop};
