...
var fancyBoxDefaults={prevEffect:"fade",nextEffect:"fade",arrows:!0,closeBtn:!0,loop:!1,helpers:{title:{type:"inside"}},minWidth:225,minHeight:50,margin:50,padding:20},fancyBoxSwipeInitialized=!1;function buildFancyboxPopIcon(t){return'<div class="fancybox-download" title="open image in new window"><a href="'+t+'" target="_blank"><img src="/images/icon_newwin.png" /></a></div>'}function initFancyBox(){var t=this.buildFancyboxPopIcon;_.extend(window,{openBoxArt:this.openBoxArt,openTechSpecs:this.openTechSpecs,openInstructions:this.openInstructions}),$(".fancybox-button-art").fancybox($.extend({beforeLoad:function(){var e=$(this.element).data("title"),n=Boolean($(this.element).data("techspecs")),o=Boolean($(this.element).data("instructions"));if(this.title=t(this.href)+e,n||o){var i='<div class="fancybox-additional-links">';n&&(i+='<a class="open-techspecs" href="javascript:void(openTechSpecs(\''+e+"'))\">Tech Specs</a>"),o&&(i+='<a class="open-instructions" href="javascript:void(openInstructions(\''+e+"'))\">Instructions</a>"),i+="</div>",this.title+=i}}},fancyBoxDefaults)),$(".fancybox-button-techspecs").fancybox($.extend({beforeLoad:function(){var e=$(this.element).data("title"),n=Boolean($(this.element).data("art")),o=Boolean($(this.element).data("instructions"));if(this.title=t(this.href)+this.title,n||o){var i='<div class="fancybox-additional-links">';n&&(i+='<a class="open-boxart" href="javascript:void(openBoxArt(\''+e+"'))\">Box Art</a>"),o&&(i+='<a class="open-instructions" href="javascript:void(openInstructions(\''+e+"'))\">Instructions</a>"),i+="</div>",this.title+=i}}},fancyBoxDefaults)),$(".fancybox-button-instructions").fancybox($.extend({beforeLoad:function(){var e=$(this.element).data("title"),n=Boolean($(this.element).data("art")),o=Boolean($(this.element).data("techspecs"));if(this.title=t(this.href)+this.title,n||o){var i='<div class="fancybox-additional-links">';n&&(i+='<a class="open-boxart" href="javascript:void(openBoxArt(\''+e+"'))\">Box Art</a>"),o&&(i+='<a class="open-techspecs" href="javascript:void(openTechSpecs(\''+e+"'))\">Tech Specs</a>"),i+="</div>",this.title+=i}}},fancyBoxDefaults))}function openBoxArt(t){$.fancybox.close(!0),$(".fancybox-button-art").filter('[title="'+t+'"]').trigger("click")}function openTechSpecs(t){$.fancybox.close(!0),$(".fancybox-button-techspecs").filter('[title="'+t+' - Tech Specs"]').trigger("click")}function openInstructions(t){$.fancybox.close(!0),$(".fancybox-button-instructions").filter('[title="'+t+' - Instructions"]').trigger("click")}function openImage(t,e){$.fancybox.open([{href:e,title:buildFancyboxPopIcon(e)+t}],fancyBoxDefaults)}module.exports={buildFancyboxPopIcon:buildFancyboxPopIcon,initFancyBox:initFancyBox,openBoxArt:openBoxArt,openTechSpecs:openTechSpecs,openInstructions:openInstructions,openImage:openImage};
